...
urlpatterns = [
    ...
    path('all_applications/<int:id>/',views.AllApplicationsView.as_view(),name="all_applications"),
    ...
    path('dashboard1/',DashboardView11.as_view(),name="dashboard1"),
